# Báo cáo đồ án Xử lý dữ liệu lớn

**Tên đề tài:** Xây dựng hệ thống Data Lakehouse phân tích dữ liệu NYC Citi Bike

Thư mục này chứa bản thảo báo cáo dưới dạng Markdown. Mỗi chương được tách thành
một file để dễ viết, phản biện và quản lý phiên bản.
...
đánh số, có tiêu đề, nguồn và được nhắc đến trong nội dung.

## Quy ước trạng thái

- `TODO(data)`: cần lấy số liệu từ pipeline.
